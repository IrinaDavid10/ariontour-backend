package com.ariontour.ariontourwebsite.configuration.security.isauthenticated;
...
public class IsAuthenticatedAspect {
    ...
    @Pointcut("@annotation(com.ariontour.ariontourwebsite.configuration.security.isauthenticated.IsAuthenticated))")
    public void annotatedMethod() {
    }

    @Pointcut("@within(com.ariontour.ariontourwebsite.configuration.security.isauthenticated.IsAuthenticated))")
